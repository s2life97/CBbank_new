...
public class TunCircularProgressIndicator extends View {
    ...
    @TunCircularProgressIndicator.Direction
    private int direction = DIRECTION_COUNTERCLOCKWISE;

    private ValueAnimator progressAnimator;

    @NonNull
    private CircularProgressIndicator.ProgressTextAdapter progressTextAdapter;

    @Nullable
    private TunCircularProgressIndicator.OnProgressChangeListener onProgressChangeListener;

    @NonNull
    private Interpolator animationInterpolator = new AccelerateDecelerateInterpolator();

    public TunCircularProgressIndicator(Context context) {
        super(context);
        init(context, null);
    }

    public TunCircularProgressIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TunCircularProgressIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TunCircularProgressIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void drawProgressBackground(Canvas canvas) {
        ...
        Paint.Style progressBackgroundStyle =  Paint.Style.FILL ;
        paint.setStyle(progressBackgroundStyle);
    ...
    public void setProgressTextAdapter(@Nullable CircularProgressIndicator.ProgressTextAdapter progressTextAdapter) {
    ...
    @NonNull
    public CircularProgressIndicator.ProgressTextAdapter getProgressTextAdapter() {
    ...
    public void setDirection(@TunCircularProgressIndicator.Direction int direction) {
        this.direction = direction;
        invalidate();
    }

    @TunCircularProgressIndicator.Cap
    public int getProgressStrokeCap() {
        return (progressPaint.getStrokeCap() == Paint.Cap.ROUND) ? CAP_ROUND : CAP_BUTT;
    }

    public void setProgressStrokeCap(@TunCircularProgressIndicator.Cap int cap) {
    ...
    public void setOnProgressChangeListener(@Nullable TunCircularProgressIndicator.OnProgressChangeListener onProgressChangeListener) {
        this.onProgressChangeListener = onProgressChangeListener;
    }

    @Nullable
    public TunCircularProgressIndicator.OnProgressChangeListener getOnProgressChangeListener() {
    ...
    public void setGradient(@TunCircularProgressIndicator.GradientType int type, @ColorInt int endColor) {
    ...
    @TunCircularProgressIndicator.GradientType
    ...
    public void setFillColorWithOpacity(int color) {
